...
public static class StorageTools
{
    ...
    [Description("Lists all currently mounted folders and their information. Mounted folder schemas are aliases to other folder IDs, or file IDs in the case of archive folders.")]
