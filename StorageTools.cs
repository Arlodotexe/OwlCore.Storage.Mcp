...
public static class StorageTools
{
    ...
    [Description("Lists all currently mounted folders and their information. Mounted folder protocol schemas are IDs that act as direct alias substitutes for other folder IDs, or file IDs in the case of archive folders. Use these mount IDs as starting points for GetItemByRelativePath navigation.")]
